      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Passionate about bridging the gap between biology and computational science
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-slate-700 leading-relaxed">
              Completed Master's in Bioinformatics at Indiana University Indianapolis,
              I'm passionate about leveraging computational methods to unlock insights
              from biological data. My journey began with a strong foundation in
              biotechnology, which led me to discover the fascinating intersection of
            ...
            <p className="text-lg text-slate-700 leading-relaxed">
              ...
              pipelines for biological research.
            </p>
            <p className="text-lg text-slate-700 leading-relaxed">
              When I'm not analyzing genomic data or optimizing pipelines, I enjoy staying
